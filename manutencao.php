...
<body>
        ...
        <div class="container-fluid">
            ...
            <div>
                <ul class="navbar m-2 ">
                    ...
                    <li class="ms-2"><a href="./logout.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row col m-1">
                <a class="btn" data-bs-toggle="collapse" href="#collapseAluno3" role="button" aria-expanded="false"
                    aria-controls="collapseAluno3">Alteração de Laboratórios</a>
            </div>
            </p>
        </div>
        <!--Collapse de Aluno-->
        ...
        <div class="collapse" id="collapseAluno3">
            <div class="card card-body mb-3">
                <div class="Alunos">
                    <p>Alterar Laboratórios de Aluno:</p>
                    <form action="./includes/student-status-update.inc.php" method="post">
                        <label for="mySelect">Curso:</label>
                        <select name="status-status">
                            <option value="">curso1</option>
                            <option value="">curso2</option>
                        </select>
                        <label for="mySelect">Semestre:</label>
                        <select name="status-status">
                            <option value="">1</option>
                            <option value="">2</option>
                        </select>
                        <label for="mySelect">Laboratório:</label>
                        <select name="status-status">
                            <option value="">lab1</option>
                            <option value="">lab2</option>
                        </select>
                        <button type="button" data-bs-toggle="modal" data-bs-target="#ModalLabAluno">Digitar RAs</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="row col m-1">
                <a class="btn" data-bs-toggle="collapse" href="#collapseNotebook" role="button" aria-expanded="false"
                    aria-controls="collapseExample">Registro</a>
            </div>
            <div class="row col m-1">
                <a class="btn" data-bs-toggle="collapse" href="#collapseNotebook2" role="button" aria-expanded="false"
            ...
            <div class="card card-body mb-3">
                <div class="Alunos">
                    ...
                    <form action="" method="get">
                        ...
                        <button type="button" data-bs-toggle="modal" data-bs-target="#ModalRegistro">Registrar</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="card card-body mb-3">
                <div class="Alunos">
                    ...
                    <form action="./includes/laptop-status-update.inc.php" method="post">
                        <input type="text" id="ativo-status" name="ativo-status" maxlength="5"
    ...
    <!-- Modal de Alteração de Lab-->
    <div class="modal fade" id="ModalLabAluno">
        <div class="modal-dialog modal-dialog-centered modal-sm modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="ModalLabAluno">Digite os RAs</h1>
    ...
    <div class="modal fade" id="ModalRegistro">
        <div class="modal-dialog modal-dialog-centered modal-sm modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input class="container" type="text" maxlength="5" placeholder="Escaneie o ativo do notebook"
                ...
                <div class="modal-footer">
                    <button type="submit" id="enviarAtivos" class="btn btn-primary">Confirmar registros</button>
                </div>
            </div>
        </div>
    </div>
